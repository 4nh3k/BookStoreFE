...
const AdminDropdown: React.FC<AdminDropdownProps> = ({title, items, value, name, onChange}) => {
    ...
    return (
        <div className="flex flex-col items-start gap-2 flex-1 self-strech flex-grow">
			...
			<Select name={name} className='self-strech w-full' required value={value} onChange={handleChange}>
