    ...
    <div className={`${className} flex w-[15.625rem] items-start bg-white border-1 border-solid border-gray-200`}>
      <div className='flex flex-col items-start gap-6 flex-1'>
        <div className='flex flex-col items-stretch gap-1 px-4 py-3 font-medium flex-wrap'>
          <SidebarItem imageSrc={PieChart} label={'Dashboard'} link={path.adminDashboard}></SidebarItem>
          <SidebarItem imageSrc={User} label={'Account'} link={path.adminAccount}></SidebarItem>
          ...
          <SidebarItem imageSrc={Voucher} label={'Voucher Management'} link={path.adminVoucherManagement}></SidebarItem>
