    ...
    <div className='bg-white flex flex-col mt-5 px-4 py-4 flex-start flex-shrink-0 min-h-screen gap-6 rounded-lg shadow-sm'>
      <div className="flex items-start basis-full gap-4 ">
        ...
        <div className="flex w-6/12 self-stretch p-4 flex-col gap-6 rounded-2xl border-1 border-solid border-gray-300 bg-white justify-between">
          ...
          <div className="flex w-full flex-wrap items-stretch justify-between gap-8">
            <RadioButton label={""} name={"address_type"} values={[{ label: 'Individual', value: 'individual' }, { label: 'Company', value: 'company' }]} />
          </div>
          <div className="flex w-full flex-wrap items-stretch justify-between gap-8">
            <AdminDropdown title={"Save address"} items={['Regular select']} />
          </div>
          <div className="flex w-full flex-wrap items-stretch justify-between gap-8">
            <AdminInput title={"First name*"} placeholder={"Enter your first name"} />
            <AdminInput title={"Last name*"} placeholder={"Enter your last name"} />
          </div>
          <div className="flex w-full flex-wrap items-stretch justify-between gap-8">
            <DiscountInput className={"flex flex-col items-strech w-full flex-wrap justify-between"} placeholder={"(+123) 456 789"} dropdownList={['+84']} enableButton={false} label="Phone number*" />
          </div>
          <div className="flex w-full flex-wrap items-stretch justify-between gap-8">
