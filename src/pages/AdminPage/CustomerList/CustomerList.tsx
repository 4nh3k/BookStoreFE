  ...
  return (
    <div className="bg-white flex flex-col mt-5 px-4 py-4 flex-start flex-shrink-0 min-h-screen gap-6 rounded-lg shadow-sm">
      ...
      <div className="w-fit flex flex-col">
        {!isLoadingUser && usersData && <Fade triggerOnce={true}><CustomTable onRowClick={onRowClick} headers={headers} data={usersData.data.data.map((user) => {
          return {
            id: user.id,
            ...
            city: user.city || '-',
            profileImageLink: user.profileImageLink || CustomerImgPlaceholder,
          }
        })} /></Fade>}
      </div>
      <Pagination
